...
<body data-ng-app="myapp" data-ng-controller="myappcontroller">
 <h3>User Registration Form</h3>
   <form data-ng-submit="processUserDetails()">
    <div class="table-responsive">
      <table class="table table-bordered" style="width: 600px">
        <tr>
          <td>Name</td>
          <td><input type="text" id="name" data-ng-model="userform.name" size="30" /></td>
        </tr>
        <tr>
          <td>Department</td>
          <td><input type="text" id="department" data-ng-model="userform.department"
             size="30" /></td>
       </tr>
       <tr>
   ...
   <div class="table-responsive">
     <table class="table table-bordered" style="width: 600px">
      ...
      <tr data-ng-repeat="user in users">
        ...
        <td><a data-ng-click="editUser(user)" class="btn btn-primary btn-sm">Edit</a>
           | <a data-ng-click="deleteUser(user)" class="btn btn-danger btn-sm">Delete</a></td>
      </tr>
    </table>
  </div>
</body>
